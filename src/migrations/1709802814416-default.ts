...
export class Default1709802814416 implements MigrationInterface {
    name = 'Default1709802814416'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "voting" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "member_id" uuid, CONSTRAINT "REL_b4347b861244f283f3cdde1e80" UNIQUE ("member_id"), CONSTRAINT "PK_2dff1e5c53fa2cc610bea30476c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "votosfavor" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" text NOT NULL DEFAULT 'Concorda', CONSTRAINT "PK_c0e783a642b19fb6e1897be37c8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "votosemabstencao" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" text NOT NULL DEFAULT 'Em abstenção', CONSTRAINT "PK_283606a41fe2ff60871332c97e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "report" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "theme" text NOT NULL, "title" text NOT NULL, "point" text NOT NULL, "reference" text, "atribuition" text, "cod_document" text NOT NULL, "Angola_participation" text NOT NULL, "decision" text NOT NULL, "summary" text NOT NULL, "meeting_number" text NOT NULL, "comment" text NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "votoscontra_id" uuid, "votosfavor_id" uuid, "votosemabstencao_id" uuid, CONSTRAINT "REL_ebefe69d7c2e034f22d554ecc8" UNIQUE ("votoscontra_id"), CONSTRAINT "REL_dee273fcad262ef1261a677947" UNIQUE ("votosfavor_id"), CONSTRAINT "REL_116c328c26cc2f198073df2025" UNIQUE ("votosemabstencao_id"), CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "votoscontra" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" text NOT NULL DEFAULT 'Discorda', CONSTRAINT "PK_3731b64107266ec2b9eee524aac" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, CONSTRAINT "UQ_8174d0498e41d6e7c108b657e79" UNIQUE ("name"), CONSTRAINT "PK_97cbbe986ce9d14ca5894fdc072" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "votosFavor_members" ("member_id" uuid NOT NULL, "votosFavor_id" uuid NOT NULL, CONSTRAINT "PK_bdf5f75f77f29093671b0b5b0f3" PRIMARY KEY ("member_id", "votosFavor_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "votosEmAbstencao_members" ("member_id" uuid NOT NULL, "votosEmAbstencao_id" uuid NOT NULL, CONSTRAINT "PK_c1e55d7f15b58bddca9b4ff6689" PRIMARY KEY ("member_id", "votosEmAbstencao_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "votoscontra_members" ("member_id" uuid NOT NULL, "votoscontra_id" uuid NOT NULL, CONSTRAINT "PK_678223d78f033881a526e19a2c6" PRIMARY KEY ("member_id", "votoscontra_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "voting" ADD CONSTRAINT "FK_b4347b861244f283f3cdde1e803" FOREIGN KEY ("member_id") REFERENCES "member"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "voting" DROP CONSTRAINT "FK_b4347b861244f283f3cdde1e803"`);
